...
(() => {
  const API_BASE = "/admin-api"; // adjust if your worker routes differ
  ...
  async function load() {
    try {
      ...
      const hpiReportNo = getField(fields, ["HPI report number", "HPI Report Number", "HPI ref", "HPI Ref"]);
      const v5cNo = getField(fields, ["V5C number", "V5C Number", "V5C Ref", "V5C"]);
