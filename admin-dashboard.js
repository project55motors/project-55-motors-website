...
async function save(id, btn) {
  ...
  try {
    ...
    // Keep local dashboard state in sync immediately.
	updateLocalCar(id, {
  	...fields,
...
// Re-apply the current filter so status moves correctly.
// Example: changing In Prep to Sold will remove it from In Prep and show it under Sold.
renderStockTable();
