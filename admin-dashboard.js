...
// Migrate legacy filter values (older builds used underscores)
if (stockFilter === "In_prep") stockFilter = "Prep";
if (stockFilter === "Arriving_soon") stockFilter = "Arriving soon";
...
function normaliseStatus(s) {
  ...
  // Accept legacy variants used earlier in the build
  if (low === "in_prep" || low === "in prep" || low === "prep") return "Prep";
  if (low === "arriving_soon" || low === "arriving soon" || low === "arriving") return "Arriving soon";

  // Canonical
  if (low === "available") return "Available";
  if (low === "sold") return "Sold";
  if (low === "hidden") return "Hidden";
