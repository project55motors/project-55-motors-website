...
async function login() {
  ...
  const p = passwordInput.value; // DO NOT trim passwords
...
async function loadStock() {
  ...
  cars.forEach(c => {
    ...
    tr.innerHTML = `
      <td>${firstPhoto ? `<img src="${firstPhoto}" width="80" loading="lazy">` : ""}</td>
