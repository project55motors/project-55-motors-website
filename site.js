  ...
  function injectFooterLegal() {
    ...
    legal.innerHTML = `
      <div class="p55-footer-legal__links">
        <a href="/terms/" data-p55-event="footer_legal_click" data-p55-label="terms">Terms</a>
        <a href="/privacy/" data-p55-event="footer_legal_click" data-p55-label="privacy">Privacy</a>
        <a href="/cookies/" data-p55-event="footer_legal_click" data-p55-label="cookies">Cookies</a>
      </div>
      <div class="p55-footer-legal__meta">
        Viewing by appointment • In-person sale • <a href="/terms/" data-p55-event="footer_legal_click" data-p55-label="terms_meta">No distance selling</a>
      </div>
    `;
