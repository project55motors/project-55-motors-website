// admin-shortcut.js – FINAL, MATCHED TO CLOUDFLARE ROUTES + MOBILE SAFE
  ...
  adminForm.addEventListener('submit', async (e) => {
    ...
    try {
      ...
      if (response.ok && result.success) {
        ...
        // Force HTTPS to protect session cookie
