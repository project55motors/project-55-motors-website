...
async function loadSingleCar() {
    ...
    try {
        // 2. Fetch the specific car data (using the Airtable filter API)
        // NOTE: Your Worker must be updated to handle filtering by ID if you want to optimize this.
        // For simplicity and speed, we will fetch ALL and filter client-side, like before.
        ...
        container.innerHTML = `
            ...
            <div class="modal-content" style="display:grid; grid-template-columns: 2fr 1fr; gap: 3rem; align-items: flex-start; max-width:1200px; margin:0 auto;">
