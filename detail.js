// detail.js – Fetches single car and renders gallery with full visible images
async function loadCarDetail() {
    ...
    try {
        ...
        const photoSectionHTML = photos.length > 0 ? `
            ...
            </div>` : `<div class="photo-section"><p style="text-align:center; padding:2rem;">No photos available for this vehicle.</p></div>`;
        ...
        contentContainer.innerHTML = `
            <div class="detail-grid">
                ...
                <div class="detail-specs">
                    ...
                    <a href="/contact.html" class="cta" style="width:100%; text-align:center;">Enquire</a>
        ...
        if (photos.length > 0) {
            document.querySelectorAll('.thumbnail').forEach(th => {
                th.addEventListener('click', function() {
                    ...
                    mainPhoto.src = this.dataset.url;
