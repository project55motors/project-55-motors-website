...
function renderVehicle(rec) {
  ...
  if (enquireBtn) {
    enquireBtn.textContent = isSold ? "Enquire Similar Vehicle" : "Enquire About This Vehicle";
  }

  enquireBtn?.addEventListener("click", () => {
    const msg = isSold
      ? `I am looking for something similar to the ${f.Make_Model} (${f.Registration}) you have just sold.`
