...
function renderVehicle(rec) {
    ...
    // FIXED: Correct hero image reference
    const heroImg = document.getElementById("vehicleMainPhoto");
    ...
    // ❗ FIXED — Preserve line breaks & formatting
    if (descEl) descEl.innerHTML = fullDesc.replace(/\n/g, "<br>");
